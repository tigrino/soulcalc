...
Scribble On Unlimited Lines Calculator (SoulCalc) is an open-source notepad-style calculator for Android and iOS. Users type mathematical expressions line by line, and results appear instantly in a column on the right. The app supports variables, line references, and persistent history.
